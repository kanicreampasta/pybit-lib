...
#define SWIGTYPE_p_std__vectorT_unsigned_char_std__allocatorT_unsigned_char_t_t swig_types[2]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pybitext

#else
#  define SWIG_init    init_pybitext

#endif
#define SWIG_name    "_pybitext"
...
SWIGINTERN PyObject *_wrap_bits_from_float(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bits_from_float" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  result = bits_from_float(arg1);
...
SWIGINTERN PyObject *_wrap_bits_from_float_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float arg2 ;
  float val1 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "bits_from_float_add", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_float(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bits_from_float_add" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  ecode2 = SWIG_AsVal_float(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "bits_from_float_add" "', argument " "2"" of type '" "float""'");
  } 
  arg2 = static_cast< float >(val2);
  result = bits_from_float_add(arg1,arg2);
  resultobj = SWIG_NewPointerObj((new std::vector< unsigned char,std::allocator< unsigned char > >(static_cast< const std::vector< unsigned char,std::allocator< unsigned char > >& >(result))), SWIGTYPE_p_std__vectorT_unsigned_char_std__allocatorT_unsigned_char_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "bits_from_float", _wrap_bits_from_float, METH_O, NULL},
	 { "bits_from_float_add", _wrap_bits_from_float_add, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
